...
public class DBHelper extends SQLiteOpenHelper{
	...
	private static String DB_PATH = "/data/data/com.ambimetrics.agenda/databases/";
	 
	private static String DB_NAME = "agenda amb.sqlite";
	...
	* */
	...
	public final static String KEY_COL2 = "apellidos";
	public final static String KEY_COL3 = "telefono";
	public final static String KEY_COL4 = "pais";
	public final static String KEY_COL5 = "provincia";
	public final static String KEY_COL6 = "ciudad";
	 
	//Array de strings para su uso en los diferentes métodos
	private static final String[] cols = new String[] { KEY_ID, KEY_COL1, KEY_COL2, KEY_COL3, KEY_COL4, KEY_COL5, KEY_COL6 };
	/**
	* INSERTAR NUEVO CONTACTO
	* */
	/**
	public long insertContacto(Integer id, String nombre, String apellidos, Integer telefono, String pais, String provincia, String ciudad) {
	ContentValues newValues = new ContentValues();
	newValues.put(KEY_ID, id);
	newValues.put(KEY_COL1, nombre);
	newValues.put(KEY_COL2, apellidos);
	newValues.put(KEY_COL3, telefono);
	newValues.put(KEY_COL4, pais);
	newValues.put(KEY_COL5, provincia);
	newValues.put(KEY_COL6, ciudad);
